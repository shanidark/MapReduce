...
const file_proto_mapreduce_proto_rawDesc = "" +
	...
	"\tpartition\x18\x01 \x01(\x05R\tpartition\" \n" +
	"\n" +
	"SpillChunk\x12\x12\n" +
	...
	"\n" +
	"ReportDone\x12\t.TaskDone\x1a\x04.Ack2l\n" +
	"\x06Worker\x12/\n" +
	"\n" +
...
var file_proto_mapreduce_proto_depIdxs = []int32{
	...
	6, // 4: Worker.FetchSpill:input_type -> FetchSpillRequest
	7, // 5: Worker.FetchResult:input_type -> FetchResultRequest
	2, // 6: Master.RegisterWorker:output_type -> Ack
	4, // 7: Master.RequestTask:output_type -> Task
	2, // 8: Master.ReportDone:output_type -> Ack
	8, // 9: Worker.FetchSpill:output_type -> SpillChunk
	8, // 10: Worker.FetchResult:output_type -> SpillChunk
